...
class BankAccountTest {
    ...
    void isEmailValidTest(){
        ...
        //-!this test shouldn't be passing, but it does-!
        assertTrue( BankAccount.isEmailValid("af@b.")); //invalid: no address
        assertTrue( BankAccount.isEmailValid("af@b.283")); //invalid: .283
